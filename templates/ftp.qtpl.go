...
`)
	//line templates/ftp.qtpl:127
	if len(error) > 0 {
		//line templates/ftp.qtpl:127
		qw422016.N().S(`
<script type="text/javascript">
    window.alert("`)
		//line templates/ftp.qtpl:129
		qw422016.E().S(error)
		//line templates/ftp.qtpl:129
		qw422016.N().S(`")
</script>
`)
		//line templates/ftp.qtpl:131
	}
	//line templates/ftp.qtpl:131
	qw422016.N().S(`
