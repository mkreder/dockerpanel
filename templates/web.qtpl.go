...
`)
	//line templates/web.qtpl:100
	if len(error) > 0 {
		//line templates/web.qtpl:100
		qw422016.N().S(`
<script type="text/javascript">
    window.alert("`)
		//line templates/web.qtpl:102
		qw422016.E().S(error)
		//line templates/web.qtpl:102
		qw422016.N().S(`")
</script>
`)
		//line templates/web.qtpl:104
	}
	//line templates/web.qtpl:104
	qw422016.N().S(`
